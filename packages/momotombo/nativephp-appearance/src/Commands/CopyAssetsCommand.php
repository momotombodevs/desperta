...
namespace Momotombo\NativephpAppearance\Commands;

use Native\Mobile\Plugins\Commands\NativePluginHookCommand;

/**
 * Copy assets hook command for Appearance plugin.
 *
...
{
    protected $signature = 'nativephp:appearance:copy-assets';

    protected $description = 'Copy assets for Appearance plugin';
    ...
    protected function copyAndroidAssets(): void
    {
        ...
        $this->info('Android assets copied for Appearance');
    }
    ...
    protected function copyIosAssets(): void
    {
        ...
        $this->info('iOS assets copied for Appearance');
    }
}
